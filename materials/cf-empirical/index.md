---
layout: sc
title: Corporate Finance (Empirical)
hero_title: Corporate Finance (Empirical)
hero_subtitle: File grid
hero_desc: causal designs, measurement, firm behavior
---
...
(async function(){
  ...
  const PATH  = "materials/cf-empirical"; // e.g., materials/econometrics
